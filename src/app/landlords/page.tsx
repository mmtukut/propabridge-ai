    ...
    <div className="bg-background text-foreground">
      ...
      <section className="py-20 lg:py-24 bg-card/20">
        <div className="container max-w-7xl">
            <div className="text-center mb-16">
                <h2 className="text-4xl md:text-5xl font-bold font-headline text-glow">Built for Property Professionals</h2>
      ...
      <section className="py-20 lg:py-24">
        <div className="container max-w-5xl text-center">
            <h2 className="text-4xl md:text-5xl font-bold font-headline text-glow mb-16">Listing Your Property is Easy</h2>
